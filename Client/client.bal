...
# API for managing staff, offices, and courses within the Faculty of Computing and Informatics.
public isolated client class Client {
    ...
    resource isolated function post lecturers(Lecturer payload) returns Inline_response_201|error {
        string resourcePath = string `/lecturers`;
